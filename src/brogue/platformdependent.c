...
unsigned int glyphToUnicode(enum displayGlyph glyph) {
    ...
    switch (glyph) {
        ...
        case G_FALLEN_TORCH: case G_FIRE: return U_FLIPPED_V;
        ...
        case G_GOOD_ITEM: case G_GOOD_MAGIC: return U_FILLED_CIRCLE_BARS;
        case G_BAD_ITEM: case G_BAD_MAGIC: return U_CIRCLE_BARS;
        ...
        case G_GLOWING_GLYPH:case G_SACRED_GLYPH:
